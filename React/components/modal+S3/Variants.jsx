    ...
    return (
        ...
        <div
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className='group relative h-[166px] flex-col center ligh rounded-xl mb-4'>
                    {Imgagen1 &&
                    ...
                    <DropImg ID={`${index}img1`} item={Imgagen1} setItem={setImgagen1} >
                        ...
                        {objeto.pictures[0] && objeto.pictures[0].startsWith("http") ?
                            ...
                            <>
                                <div className='mx-auto h-14 w-14 yellow rounded-full center cursor-pointer'>
                                ...
                                <div className='text-center mx-4 font-medium'>
